...
public class Main {
    ...
    public static void exercise3() {
        ...
        switch (myDate.getDayOfWeek()){
            ...
            case TUESDAY, WEDNESDAY, THURSDAY, FRIDAY -> System.out.println("We are in the middle of the week, time to do some good work!");
            case SATURDAY, SUNDAY -> System.out.println("WHAT ARE YOU DOING? WHY ARE YOU CORRECTING THE EXERCISES TODAY? IT'S WEEKEND! GRAB SOMETHING TO DRINK AND GO PARTY NOW!");
        }
